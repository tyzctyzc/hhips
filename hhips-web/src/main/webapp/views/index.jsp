...
<header id="header">
	<ul id="menu">
		...
		<li id="logo" class="hidden-xs">
			...
			<span id="system_title">HHIPS Frame</span>
		</li>
		<li class="pull-right">
			<ul class="hi-menu">
				<!-- 搜索 -->
	...
	<section id="content">
		...
		<div class="content_main">
			<div id="iframe_home" class="iframe cur">
				...
				<p><b>代码已托管至<a href="https://github.com/tyzctyzc/hhips" target="_blank"> github</a>，目前正在不断完善，敬请期待...</b></p>
				<p>Created by Tyzctyzc Since 2018</p>
				<p>Copyright <a href="https://github.com/tyzctyzc" target="_blank">https://github.com/tyzctyzc</a>. All rights reserved.</p>
			</div>
		</div>
	</section>
</section>
...
<script type="text/javascript">
	...
	function loadMenu(roleId){
		...
		$.post('${pageContext.request.contextPath}/'+roleId+'/menu',null,function(data){
			...
			menuHtml += "<li><div class='upms-version'>&copy; HHIPS FRAME V1.0</div></li>";
