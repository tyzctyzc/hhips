...
public class LoginController extends BaseController {
    ...
    public LoginModel signin(String username, String password, boolean remember) {
        ...
        LoginUser loginUser = delegateService.selectOne("com.hhips.dao.mapper.login.LoginCustomMapper.getLoginUser", paramMap);
        ...
        List<Map<String, Object>> userRoles = delegateService.selectList("com.hhips.dao.mapper.login.LoginCustomMapper.getUserRoles", loginUser.getUserId());
        if (!this.isNull(userRoles))
            loginUser.setUserRoles(userRoles);


        System.out.println("hhips -> Log 输出：" + loginUser);
