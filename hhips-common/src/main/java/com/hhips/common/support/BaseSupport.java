package com.hhips.common.support;
 ...
 * name：BaseSupport
 *
 * description：base support class. Include common function and constant
 *
 */
public abstract class BaseSupport {

    /**
     * Judge whether object is null
     *
     * @param obj object
     * @return if is null, return true，otherwise return false
     */
